...
export default function ChatPage() {
    ...
    useEffect(() => {
        async function fetchChats() {
            try {
                // Fetch 'allChats' data
                const allChatsResponse = await fetch('https://offthepath-webapp-default-rtdb.firebaseio.com/allChats.json');
                const allChatsData = await allChatsResponse.json();

                // Fetch 'matchChats' data
                const matchChatsResponse = await fetch('https://offthepath-webapp-default-rtdb.firebaseio.com/matchChats.json');
    ...
    const chatsToDisplay = activeTab === "all" ? chats.allChats : chats.matchChats;
